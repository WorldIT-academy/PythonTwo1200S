...
class WidgetHorizontalScroll(ctk.CTkScrollableFrame):
    ...
    def request_api(self ):
        ...
        try:
            weather_data = requests.get(url = f"https://api.openweathermap.org/data/2.5/forecast?q={CITY_NAME}&appid={API_KEY}&units=metric")
            print("Дані отримані")
        ...
        print(json.dumps(hourly_data, indent = 4))
